...
# 1. Initial ls tbs
let init = (l tbs)  # Updated to correct command invocation
assert str contains $init "Existing tables"

# 2. Add table 'tbl' with initial field and value
let added = (a tb tbl field1 value1)  # Updated to correct command invocation

# 3. ls tbs shows 'tbl'
let after_ls = (l tbs)  # Updated to correct command invocation
assert str contains $after_ls "tbl"

print (apply_color "blue" "[Test 2] Testing field commands...")

# 4. Add field 'newfield'
a fd newfield  # Updated to correct command invocation
let fields1 = (l fds)  # Updated to correct command invocation
let fields1_str = ($fields1 | str join "\n")
assert str contains $fields1_str "newfield"

# 5. Remove field 'newfield'
d fd newfield  # Updated to correct command invocation
let fields2 = (l fds)  # Updated to correct command invocation
...
# 10. Remove table 'tbl'
d tb tbl  # Updated to correct command invocation
